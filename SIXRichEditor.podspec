#
#  Be sure to run `pod spec lint SIXRichEditor.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "ljl" => "liujiliu1989@163.com" }
  # Or just: s.author    = "ljl"
  # s.authors            = { "ljl" => "liujiliu1989@163.com" }
  # s.social_media_url   = "http://twitter.com/ljl"
